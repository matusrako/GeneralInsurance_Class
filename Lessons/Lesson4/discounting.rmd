...
```{r}
## House & Large & PAID:
Paid_HH_sml <- dt_PaidCase %>% filter(Business == "House" & ClaimSize == "Large" & dataset_type == "PAID") 
Paid_HH_sml_triangle <- Paid_HH_sml %>% as.triangle(Paid_HH_sml, origin = "ay", dev = "dy", value = "SumOfamount")
...
Paid_HH_sml <- dt_PaidCase %>% filter(Business == "3rd Party" & ClaimSize == "Large" & dataset_type == "PAID") 
Paid_HH_sml_triangle <- Paid_HH_sml %>% as.triangle(Paid_HH_sml, origin = "ay", dev = "dy", value = "SumOfamount")
Paid_HH_sml_triangle <- triangle(Paid_HH_sml_triangle[,10], Paid_HH_sml_triangle[,9], Paid_HH_sml_triangle[,1], Paid_HH_sml_triangle[,2], Paid_HH_sml_triangle[,3], Paid_HH_sml_triangle[,4], Paid_HH_sml_triangle[,5], Paid_HH_sml_triangle[,6], Paid_HH_sml_triangle[,7], Paid_HH_sml_triangle[,8])
plot(Paid_HH_sml_triangle)
plot(predict(chainladder(Paid_HH_sml_triangle)))
...
Paid_HH_sml <- dt_PaidCase %>% filter(Business == "3rd Party" & ClaimSize == "Small")
Paid_HH_sml_triangle <- Paid_HH_sml %>% as.triangle(Paid_HH_sml, origin = "ay", dev = "dy", value = "SumOfamount")
Paid_HH_sml_triangle <- triangle(Paid_HH_sml_triangle[,10], Paid_HH_sml_triangle[,9], Paid_HH_sml_triangle[,1], Paid_HH_sml_triangle[,2], Paid_HH_sml_triangle[,3], Paid_HH_sml_triangle[,4], Paid_HH_sml_triangle[,5], Paid_HH_sml_triangle[,6], Paid_HH_sml_triangle[,7], Paid_HH_sml_triangle[,8])
plot(Paid_HH_sml_triangle)
plot(predict(chainladder(Paid_HH_sml_triangle)))
...
# Medzi veľkými a malými škodami som nezaznamenal dramatické rozdiely.
...
## House & Large:
Incur_HH_sml <- dt_PaidCase %>% filter(Business == "House" & ClaimSize == "Large") 
Incur_HH_sml_triangle <- Incur_HH_sml %>% as.triangle(Incur_HH_sml, origin = "ay", dev = "dy", value = "SumOfamount")
Incur_HH_sml_triangle <- triangle(Incur_HH_sml_triangle[,10], Incur_HH_sml_triangle[,9], Incur_HH_sml_triangle[,1], Incur_HH_sml_triangle[,2], Incur_HH_sml_triangle[,3], Incur_HH_sml_triangle[,4], Incur_HH_sml_triangle[,5], Incur_HH_sml_triangle[,6], Incur_HH_sml_triangle[,7], Incur_HH_sml_triangle[,8])
plot(Incur_HH_sml_triangle)
plot(predict(chainladder(IncurHH_sml_triangle)))
...
## 3rd Party & Large:
Incur_HH_sml <- dt_PaidCase %>% filter(Business == "3rd Party" & ClaimSize == "Large") 
Incur_HH_sml_triangle <- Incur_HH_sml %>% as.triangle(Incur_HH_sml, origin = "ay", dev = "dy", value = "SumOfamount")
Incur_HH_sml_triangle <- triangle(Incur_HH_sml_triangle[,10], Incur_HH_sml_triangle[,9], Incur_HH_sml_triangle[,1], Incur_HH_sml_triangle[,2], Incur_HH_sml_triangle[,3], Incur_HH_sml_triangle[,4], Incur_HH_sml_triangle[,5], Incur_HH_sml_triangle[,6], Incur_HH_sml_triangle[,7], Incur_HH_sml_triangle[,8])
plot(Incur_HH_sml_triangle)

## 3rd Party & Small:
Incur_HH_sml <- dt_PaidCase %>% filter(Business == "3rd Party" & ClaimSize == "Small") 
Incur_HH_sml_triangle <- Incur_HH_sml %>% as.triangle(Incur_HH_sml, origin = "ay", dev = "dy", value = "SumOfamount")
Incur_HH_sml_triangle <- triangle(Incur_HH_sml_triangle[,10], Incur_HH_sml_triangle[,9], Incur_HH_sml_triangle[,1], Incur_HH_sml_triangle[,2], Incur_HH_sml_triangle[,3], Incur_HH_sml_triangle[,4], Incur_HH_sml_triangle[,5], Incur_HH_sml_triangle[,6], Incur_HH_sml_triangle[,7], Incur_HH_sml_triangle[,8])
plot(Incur_HH_sml_triangle)
plot(predict(chainladder(IncurHH_sml_triangle)))
...
# Cca 4-5 rokov trvá strata Houses, kým pre 3rd Party to trvá dlhšie. Dôvod: Ak sa niečo stane s domom, je to väčšinou rýchlo zaplatené bez ďalších nákladov do budúcna, kým v prípade nehôd áut bývajú častejšie aj zdravotné škody (liečenie, práceneschopnosť), množstvo drobnejších vecí zasahujúcich do bežného chodu poškodeného, čo časovo výraznejšie predĺžuje vznik ďalších nákladov.
