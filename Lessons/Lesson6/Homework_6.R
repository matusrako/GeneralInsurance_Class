...
emblem_graph(
  ...
  target = "Burning_Cost",
  prediction = "pred" )
# Z grafu vidíme, že u vodièoch mladších ako 33, resp. starších ako 56, sú pomerne ve¾ké výkyvy dôsledku malého poètu dát, èo negatívne ovplyvòuje trend.
...
emblem_graph(
  ...
  target = "Burning_Cost",
  prediction = "pred" )
# Z grafu vidíme, že u vozidiel vyrobených pred rokom 2006, sú pomerne ve¾ké výkyvy dôsledku malého poètu dát, èo negatívne ovplyvòuje trend.
...
# Hodnota MSE sa ve¾mi mierne zvýšila, teda možno skonštatova, že zgrupovanie nám nepomohlo model vylepši.
...
emblem_graph(
  ...
  target = "Burning_Cost",
  prediction = "pred" )
# Z grafu vidíme, že u vozidiel typu MOTORBIKE a TRUCK, sú pomerne ve¾ké výkyvy dôsledku malého poètu dát, èo negatívne ovplyvòuje trend.
# Zgrupime preto tieto skupiny.
